...
/**
 * Database manager for handling knex connection lifecycle.
 */
class DatabaseManager {
    ...
    /**
     * Create and verify a database connection.
    ...
    /**
     * Get a ready-to-use knex instance.
     * @returns {Promise<object>} Knex instance
     */
    async getKnex() {
        if (!this.knex) {
...
/**
 * Handle process termination signal for graceful shutdown.
 */
